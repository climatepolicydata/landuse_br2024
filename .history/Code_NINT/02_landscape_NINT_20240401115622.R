...
write_parquet(
  x = nint_sectorlandscape_climateUse,
  sink = "A:\\projects\\landuse_br2024\\NINT\\NINT_ArrowFile.parquet")
library(lexRankr)
a = nint_sectorlandscape_climateUse%>% slice(1)

top_3 = lexRankr::lexRank(string_sem_n,
...
asd<- top_3[[3]] %>% as_tibble
asd %>% write_csv2("asd.csv")
