...
df_oecd_sector_reference_table_automatic <- df_oecd_sector_reference_table_automatic %>% 
  ...
  dplyr::mutate(sector_landscape = ifelse(crs_identification_n %in% c("2021001429","2021009820","2021000019",'2021000610',"2021000697","2021000042",
                                                                      "2021000043", "2021100491","2021000013","2021004343-1","2021004403"), "Crop", sector_landscape)) %>% 
  ...
  dplyr::mutate(sector_landscape = ifelse(crs_identification_n %in% c("2021006906","2021000682",
                                                                      "2021000705","2018001302","2021110099","2021110100",
                                                                      "2021100252"),"Multi-sector", sector_landscape))
...
df_oecd_sector_reference_table_automatic <- df_oecd_sector_reference_table_automatic %>% 
  dplyr::mutate(sector_landscape = ifelse(crs_identification_n %in% c("2021001975", "2022000005", "2022000047", "2022000151", "2022000211", "2022001463-1",
                                                                      ...
                                                                      "2022meae003988", "2022meae003989", "2022meae003990", "2022meae004016","2022000259"), "Crop", sector_landscape)) %>%
  ...
  dplyr::mutate(sector_landscape = ifelse(crs_identification_n %in% c("2022149069"),"Multi-sector",sector_landscape)) %>%
...
df_oecd_sector_reference_table_manual <- df_oecd_sector_reference_table_manual %>% 
  ...
  dplyr::mutate(sector_landscape = ifelse(crs_identification_n %in% c("2018001585",	"2018001586",	"2020000042",	"2021000032",	"2021000033",	"2021000035",	"2021000036",	"2021000037",
                                                                      ...
                                                                      "2021004603",	"2021027587",	"2021638010",	"2021668038",	"2021668042","2021000901"), "Forest", sector_landscape)) %>% 
  dplyr::mutate(sector_landscape = ifelse(crs_identification_n %in% c("2021000047",	"2021000116",	"2021000181",	"2021000188",	"2021000313",	"2021000790",
                                                                      "2021000814", "2021000961",	"2021001063",	"2021001238",	"2021002575",	
...
df_oecd_sector_reference_table_manual <- df_oecd_sector_reference_table_manual %>% 
  ...
  dplyr::mutate(sector_landscape = ifelse(crs_identification_n %in% c("2020001103", "2021000035", "2022000004", "2022000005", "20220000360001", "2022000039",
                                                                      ...
                                                                      "2022ird00083", "2022meae005209", "2022meae005210", "2022meae005212", "2022meae005214","2022060222i"),"Forest",sector_landscape)) %>% 
  dplyr::mutate(sector_landscape = ifelse(crs_identification_n %in% c("2022001738-1", "2022026001", "2021003308", "2021003312",
                                                                      ...
                                                                      "2022007038", "2022009255", "2022060222a", "2022060222c", "2022060222h"),"Multi-sector", sector_landscape)) %>% 
