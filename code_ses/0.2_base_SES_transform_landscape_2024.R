...
## Export land use landscape 
#write.csv2(, paste0(dir_susep_dt_clean, "ses_clear_", ano_fim, ".csv"))
write.csv2(df_ses_calculus2, paste0(dir_susep_output, "ses_landscape_landuse_",ano_ini, "_", ano_fim, ".csv"), fileEncoding = "latin1") 
