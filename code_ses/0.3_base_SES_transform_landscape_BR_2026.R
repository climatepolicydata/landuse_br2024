...
# import DF for landscape of land use to transform
#setwd(dir_susep_output)

#df_ses_calculus2 <- read_delim(paste0(dir_susep_output, "ses_landscape_landuse_",ano_ini, "_", ano_fim, ".csv"))
df_ses_calculus2 <- read_delim(
  paste0(dir_susep_output, "ses_landscape_landuse_",ano_ini, "_", ano_fim, ".csv"),
  delim = ";",
